...
const TaskTable = () => {
  ...
  const tasks = [
    {
      id: "01",
      subject: "Follow up on leads from trade show",
      priority: "High",
      status: "Incomplete",
      assigned: "Alison Greene",
      contact: "Natukunda Cathy",
      date: "Apr 24, 2024",
    },
    {
      id: "02",
      subject: "Close deals from client A",
      priority: "Normal",
      status: "Complete",
      assigned: "Mary Bata",
      contact: "Luswata Andrew",
      date: "Jan 24, 2024",
    },
    {
      id: "03",
      subject: "Register for upcoming webinar",
      priority: "Low",
      status: "Complete",
      assigned: "Alex War",
      contact: "Alur John",
    ...
    {
      id: "04",
      subject: "Get deals from client B",
      priority: "High",
      status: "Complete",
      assigned: "Mary Bata",
      contact: "Ema Wambi",
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="text-gray-400 text-sm font-semibold border-b border-gray-100">
                ...
                <th className="pb-5 pr-2 text-right">
            ...
            <tbody className="divide-y divide-gray-50">
              {tasks.map((task) => (
                ...
                >
                  ...
                  {isAdmin && (
                    <td className="py-6 pr-2 text-right flex items-center gap-3">
